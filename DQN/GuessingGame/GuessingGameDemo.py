...
class GuessingGameSolver:
    def __init__(self, n_episodes=1000, n_win_ticks=20, max_env_steps=None, gamma=0.9, epsilon=0.5, epsilon_min=0.01,
                 epsilon_log_decay=0.995, alpha=0.01, alpha_decay=0.01, batch_size=256, quiet=False,
                 plot=False):
    ...
    def run(self):
        try:
            self.model.load_weights('guessing.h5')
        except:
        ...
        for e in range(self.n_episodes):
            ...
            self.model.save_weights('guessing.h5')
